...
const NewBookMore = () => {
    ...
    return (
        <div className="new-book-more">
            <div className="container">
                <div className="new-book-more--main">
                    <div className="new-book-more--search">
                    ...
                    <div className="new-book-more--container">
                        <div className="card-header">
                            <h2>SÁCH MỚI</h2>
                        </div>
                        <div className="new-book-more--card-container">
                            {listNewCard.map((item, index) => {
                                return <div className="new-card-more-item" >
